...
function dispose(buffer) {
  Tile.prepDevice.bindBuffer(34962, null);
  Tile.prepDevice.deleteBuffer(buffer.vertexBuffer);
  buffer.vertexBuffer = null;
}

export class TimeSeriesPointVertex {
  constructor(count) {
    this.pointSize = 0;
    this.tu = 0;
    this.tv = 0;
  ...
  static create(position, size, time, color) {
...
export class TimeSeriesPointVertexBuffer {
  constructor(count) {
    this.count = 0;
    this._verts$1 = null;
    this.count = count;
...
export class PositionColoredVertexBuffer {
  constructor(count) {
...
export class PositionColoredTexturedVertexBuffer {
  constructor(count) {
...
export class TimeSeriesPointSpriteShader {
  ...
  static use(renderContext, vertex, texture, lineColor, zBuffer, jNow, decay, camera, scale, minSize, showFarSide, sky) {
    if (texture == null) {
...
export class PositionVertexBuffer {
  constructor(count) {
    this.count = 0;
    this._verts$1 = null;
    this.count = count;
...
export class PositionTextureVertexBuffer {
  constructor(count) {
...
export class PositionNormalTexturedVertexBuffer {
  constructor(count) {
    this.count = 0;
    this._verts$1 = null;
    this.count = count;
...
export class PositionNormalTexturedTangentVertexBuffer {
  constructor(count) {
...
export class KeplerVertexBuffer {
  constructor(count) {
...
export class TimeSeriesLineVertexBuffer {
  constructor(count) {
