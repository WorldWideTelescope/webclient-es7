...
export class TileShader {
  ...
  static use(renderContext, vertex, index, texture, opacity, noDepth) {
    if (texture == null) {
...
export class SpriteShader {
  ...
  static use(renderContext, vertex, texture) {
    if (texture == null) {
      texture = Texture.getEmpty();
    }
    const gl = renderContext.gl;
...
export class SimpleLineShader {
  ...
  static use(renderContext, vertex, lineColor, useDepth) {
    const gl = renderContext.gl;
    if (gl != null) {
...
export class SimpleLineShader2D {
  static init(renderContext) {
    const gl = renderContext.gl;
    const fragShaderText = '   precision highp float;                                                          \n' + '   uniform vec4 lineColor;                                                         \n' + '                                                                                   \n' + '   void main(void) {                                                               \n' + '       gl_FragColor = lineColor;                                                   \n' + '   }                                                                               \n';
...
export class OrbitLineShader {
  ...
  static use(renderContext, vertex, lineColor) {
    const gl = renderContext.gl;
    if (gl != null) {
...
export class LineShaderNormalDates {
  static init(renderContext) {
    const gl = renderContext.gl;
    const fragShaderText = '    precision highp float;                                                              \n' + '    uniform vec4 lineColor;                                                             \n' + '    varying lowp vec4 vColor;                                                           \n' + '    void main(void)                                                                     \n' + '    {                                                                                   \n' + '        gl_FragColor = lineColor * vColor;                                              \n' + '    }                                                                                   \n';
  ...
  static use(renderContext, vertex, lineColor, zBuffer, jNow, decay) {
    const gl = renderContext.gl;
    if (gl != null) {
...
export class KeplerPointSpriteShader {
  static init(renderContext) {
    const gl = renderContext.gl;
  ...
  static use(renderContext, worldView, vertex, texture, lineColor, opacity, zBuffer, jNow, MM, camera, scale, minSize) {
    if (texture == null) {
      texture = Texture.getEmpty();
    }
    const gl = renderContext.gl;
...
export class EllipseShader {
  ...
  static use(renderContext, semiMajorAxis, eccentricity, eccentricAnomaly, lineColor, opacity, world, positionNow) {
    const gl = renderContext.gl;
    if (gl != null) {
...
export class ModelShader {
  ...
  static use(renderContext, vertex, index, texture, opacity, noDepth, stride) {
    if (texture == null) {
      texture = Texture.getEmpty();
    }
    const gl = renderContext.gl;
...
export class ShapeSpriteShader {
  static init(renderContext) {
    const gl = renderContext.gl;
    const fragShaderText = ' precision mediump float;                                                                \n' + '                                                                                         \n' + '   varying lowp vec4 vColor;                                                             \n' + '                                                                                         \n' + '   void main(void) {                                                                     \n' + '   gl_FragColor =  vColor;                                                               \n' + '   }                                                                                     \n';
    const vertexShaderText = '     attribute vec3 aVertexPosition;                                              \n' + '     attribute lowp vec4 aColor;                                                  \n' + '                                                                                  \n' + '     uniform mat4 uMVMatrix;                                                      \n' + '     uniform mat4 uPMatrix;                                                       \n' + '                                                                                  \n' + '     varying vec2 vTextureCoord;                                                  \n' + '     varying vec4 vColor;                                                         \n' + '                                                                                  \n' + '                                                                                  \n' + '     void main(void) {                                                            \n' + '         gl_Position = uPMatrix * uMVMatrix * vec4(aVertexPosition, 1.0);         \n' + '         vColor = aColor;                                                         \n' + '     }                                                                            \n' + '                                                                                  \n';
  ...
  static use(renderContext, vertex) {
    const gl = renderContext.gl;
    if (gl != null) {
