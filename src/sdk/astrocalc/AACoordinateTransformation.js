...
CT.eq2H = (LocalHourAngle, Delta, Latitude) => {
...
CT.h2Eq = (Azimuth, Altitude, Latitude) => {
...
CT.d2R = Degrees => Degrees * 0.0174532925199433;
CT.r2D = Radians => Radians * 57.2957795130823;
CT.r2H = Radians => Radians * 3.81971863420549;
CT.h2R = Hours => Hours * 0.261799387799149;
CT.h2D = Hours => Hours * 15;
CT.d2H = Degrees => Degrees / 15;
CT.PI = () => Math.PI;
CT.m360 = Degrees => Degrees - Math.floor(Degrees / 360) * 360;
CT.m24 = HourAngle => HourAngle - Math.floor(HourAngle / 24) * 24;
CT.dmS2D = (Degrees, Minutes, Seconds) => CT.dmS2Dp(Degrees, Minutes, Seconds, true);
CT.dmS2Dp = (Degrees, Minutes, Seconds, bPositive) => {
  if (!bPositive) {
